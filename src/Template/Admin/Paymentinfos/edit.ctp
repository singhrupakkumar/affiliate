<section class="content-header">
   ...
   <?= __('Edit User Card') ?>
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><?= __('Edit User Card') ?></li>
    </ol>
</section>
...
<section class="content">
	<div class="row">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?= $this->Form->create($payinfo, ['id' => 'card-form', 'enctype' => 'multipart/form-data']) ?>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select id="exp_month" name="user_id" class="form-control" required="required">
                     ...
                     <option value="<?php echo $user['id'];  ?>" <?php if($user['id'] ==$payinfo['user_id']){ echo "selected";}   ?>><?php echo $user['name'];  ?></option>
                       <?php }
                        }
                        ?>
                  </select>
                ...
                <div class="form-group">
                 ...
                 <select id="exp_month" name="exp_month" class="form-control">
                                            ...
                                            for($i = 1; $i <= 12; $i++){
                                              ?>  
                     <option value="<?php echo $i;?>" <?php if($i ==$payinfo['exp_month']){ echo "selected";}   ?>><?php echo $i;?></option>
                                          <?php
                                          }
                                            ?>
                  </select>
                ...
                <div class="form-group">
                    ...
                    <select name="exp_year" id="exp_year" class="form-control">
                      ...
                      for($i = date("Y"); $i < date("Y")+20; $i++){?>
                            <option value="<?php echo $i;?>" <?php if($i ==$payinfo['exp_year']){ echo "selected";}   ?>><?php echo $i;?></option>
                     <?php
                     }
                      ?>
                    </select>
